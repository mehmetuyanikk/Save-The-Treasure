...
public class InputController
{
    ...
    public void RegisterInputControl(InputField _email, InputField _username, InputField _password, InputField _repeatPassword,
        Button _registerButton)
    {
        if (_email.text.IndexOf('@') < 0 || _email.text.IndexOf('.') < 0 || _username.text.IndexOf('_') > 0 || _username.text.Length < 3 || 
            _password.text != _repeatPassword.text || _password.text.Length < 6)
        {
